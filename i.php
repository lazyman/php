...
<a name="checkmysql"></a>
<form action="<?php echo $_SERVER[PHP_SELF]."#checkmysql";?>" method="post">
<!--MySQL数据库连接检测-->
<table width="100%" cellpadding="3" cellspacing="0" align="center">
...
<a name="checkfun"></a>
<form action="<?php echo $_SERVER[PHP_SELF]."#checkfun";?>" method="post">
<!--函数检测-->
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <td width="25%">
      <input type="hidden" name="act" value="函数检测" />
      <input class="btn" type="submit" align="right" value="函数检测" />
    </td>
  </tr>
  <?php
  if ($_POST['act'] == '函数检测') {
  ?>
  <tr>
  	<td colspan="3" background-color="green">
  <?php
  	echo $funRe;
  }
  ?>
